...
# ABRIR UM MÉTODO E CRIAR UMA VALIDAÇÃO CUSTOMIZADA
...
# FAZER CONFIGURAÇÃO DE CORS NO DJANGO INSTALANDO A BIBLIOTECA ABAIXO:
# pip install django-cors-headers
# ADICIONAR NO INSTALLED_APP ("corsheaders")
